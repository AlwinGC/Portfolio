...
function Footer() {
    return (
      	<footer id="footer">
			<ul className="icons">
				<li><a href="https://www.instagram.com/alwin_christie/" className="icon"><i className="fab fa-instagram fa-2x"></i><span className="label">Instagram</span></a></li>
			...
			<ul className="menu">
				<li>Portfolio - Alwin Christie</li>
			</ul>
		</footer>
    );
  }
